...
-- Either always short circuits to the first thing that failed.
-- there is no Monad for Validation. Applicative and Monad instances must have the same behavior.
